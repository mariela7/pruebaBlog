...
namespace Blog.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public JsonResult JsonLogin(LoginModel model, string returnUrl)
        {
            ...
            // Si llegamos hasta aquí, se ha producido un error
        ...
        private static void InitiateDatabaseForNewUser(string userName)
        {
            ...
            todoList.Todos.Add(new TodoItem() { Title = "Elemento de tarea 1", TodoListId = todoList.TodoListId, IsDone = false });
            todoList.Todos.Add(new TodoItem() { Title = "Elemento de tarea 2", TodoListId = todoList.TodoListId, IsDone = false });
            db.SaveChanges();
        }
